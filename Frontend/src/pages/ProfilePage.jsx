...
import { 
  ...
  Camera, LogOut, Activity, Settings, Zap, Mail, ChevronRight, Lock, User
} from 'lucide-react';
  ...
  return (
    <div className="h-screen bg-white flex overflow-hidden font-sans text-zinc-900 selection:bg-indigo-100">
      ...
      <aside className="w-64 bg-gray-50 border-r border-gray-200 flex flex-col p-6 z-20">
        ...
        <button 
          onClick={() => navigate(-1)} 
          className="group flex items-center gap-2.5 text-xs font-black uppercase tracking-[0.2em] text-zinc-400 hover:text-indigo-600 transition-all mb-10 active:scale-95"
        >
          <div className="p-2 rounded-lg bg-white border border-gray-200 group-hover:border-indigo-200 group-hover:shadow-sm transition-all">
        ...
        <div className="flex flex-col items-center mb-10 px-2 text-center">
          ...
          <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mt-1">Verified Account</p>
        </div>
          ...
          {activeTab === 'overview' ? (
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
              <div className="md:col-span-3 bg-indigo-600 p-10 rounded-[2rem] relative overflow-hidden group shadow-2xl shadow-indigo-100">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-indigo-100 text-base font-medium leading-relaxed max-w-sm">
                    Your workspace is active. You've completed <span className="text-white font-black underline decoration-indigo-300 decoration-2 underline-offset-4">{stats.completed} tasks</span>.
                  </p>
                </div>
              </div>

              <div className="bg-white p-8 rounded-[2rem] border border-gray-100 flex flex-col items-center justify-center shadow-md hover:shadow-lg transition-shadow">
                <div className="relative w-24 h-24 mb-4 text-indigo-600">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center text-xl font-bold tracking-tighter text-zinc-800 tabular-nums">
                    {stats.efficiency}
                  </div>
                </div>
              ...
              <div className="bg-emerald-50 border border-emerald-100 p-8 rounded-[2rem] flex flex-col justify-between group hover:bg-emerald-100 transition-all hover:-translate-y-1">
                ...
                <div className="mt-6">
                  <p className="text-4xl font-black text-emerald-700 tracking-tighter tabular-nums">{stats.completed}</p>
              ...
              <div className="bg-white border border-gray-100 p-8 rounded-[2rem] flex flex-col justify-between group hover:border-indigo-100 transition-all shadow-md hover:-translate-y-1">
                ...
                <div className="mt-6">
                  <p className="text-4xl font-black text-zinc-800 tracking-tighter tabular-nums">{stats.inProgress}</p>
              ...
              <div className="md:col-span-2 bg-gray-50 border border-gray-100 p-8 rounded-[2rem]">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 rounded-xl bg-white border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="max-w-2xl mx-auto space-y-10 animate-in fade-in slide-in-from-right-2 duration-500">
              ...
              <div className="space-y-6">
                <div className="bg-white p-8 rounded-[2.5rem] border border-gray-200 shadow-lg shadow-gray-100 space-y-8">
                  <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-indigo-600">Identity Details</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <label className="text-[10px] font-black uppercase tracking-widest text-zinc-400 ml-1">Email Key</label>
                  ...
                  <button className="w-full py-4 bg-indigo-600 text-white rounded-2xl font-black uppercase tracking-[0.2em] text-[11px] hover:bg-indigo-700 active:scale-[0.98] transition-all shadow-xl shadow-indigo-100">
                  ...
                  <button className="w-full flex items-center justify-between p-5 bg-white rounded-2xl border border-gray-200 hover:border-indigo-300 transition-all group shadow-sm">
                    <div className="flex items-center gap-5">
                      ...
                      <div className="text-left">
                        <p className="text-base font-bold text-zinc-800 leading-tight">Rotation: Access Key</p>
